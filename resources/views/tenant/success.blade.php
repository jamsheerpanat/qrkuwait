...
@section('content')
    <div class="py-20 flex flex-col items-center text-center max-w-lg mx-auto" x-data="{ showUpload: false }"
                ...
                <div class="bg-blue-50 border-2 border-blue-200 rounded-[2.5rem] p-8 text-left space-y-4">
                    ...
                    <ol class="space-y-2 text-sm font-bold text-blue-900">
                        ...
                        <li class="flex gap-2">
                            ...
                            <span>Send the screenshot via WhatsApp with your order number</span>
                        </li>
                    </ol>
                </div>
            @endif
            ...
            <div class="space-y-4">
                ...
                @if($order->payment_method === 'cash')
                    <div class="flex justify-between font-bold text-sm">
                        ...
                        <span class="text-amber-600">Pay on {{ $order->delivery_type === 'delivery' ? 'Delivery' : 'Pickup' }}</span>
                    </div>
                @else
                    <div class="flex justify-between font-bold text-sm">
                        <span class="text-slate-400">Payment Status</span>
                        <span class="text-blue-600">Awaiting Confirmation</span>
                    </div>
                @endif
            </div>
        </div>
